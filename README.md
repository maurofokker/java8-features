...
- [Java 8 features](#java-8-features)
  * [Imperative vs Declarative programmig](#imperative-vs-declarative-programmig)
  * [Lambda expression](#lambda-expression)
    + [Local variables in lambda](#local-variables-in-lambda)
    + [Effectively Final variables](#effectively-final-variables)
  * [Functional Interfaces](#functional-interfaces)
    + [Consumer<T> Functional Interface](#consumer-t--functional-interface)
    + [BiConsumer<T, U> Functional Interface](#biconsumer-t--u--functional-interface)
    + [Predicate<T> Functional Interface](#predicate-t--functional-interface)
    + [BiPredicate<T, U> Functional Interface](#bipredicate-t--u--functional-interface)
    + [Function<T, R> Functional Interface](#function-t--r--functional-interface)
    + [BiFunction<T, U, R> Functional Interface](#bifunction-t--u--r--functional-interface)
    + [UnaryOperator<T> Functional Interface](#unaryoperator-t--functional-interface)
    + [BinaryOperator<T> Functional Interface](#binaryoperator-t--functional-interface)
    + [Supplier<T> Functional Interface](#supplier-t--functional-interface)
  * [Method Reference](#method-reference)
  * [Constructor Reference](#constructor-reference)
  * [Streams API](#streams-api)
    + [Collections vs Streams](#collections-vs-streams)
    + [Using peek() method to debug stream](#using-peek---method-to-debug-stream)
    + [Operation: map()](#operation--map--)
    + [Operation: flatMap()](#operation--flatmap--)
    + [Operations: distinct() - count() - sorted()](#operations--distinct-----count-----sorted--)
    + [Operation: filter()](#operation--filter--)
    + [Operation: reduce()](#operation--reduce--)
    + [Operation: limit()](#operation--limit--)
    + [Operation: skip()](#operation--skip--)
    + [Operation: anyMatch() - allMatch() - noneMatch](#operation--anymatch-----allmatch-----nonematch)
    + [Operation: findFirst() - findAny()](#operation--findfirst-----findany--)
    + [Operation: of() - generate() and iterate()](#operation--of-----generate---and-iterate--)
    + [Terminal Operators in collect()](#terminal-operators-in-collect--)
      - [Operation: Collectors.joining()](#operation--collectorsjoining--)
      - [Operation: Collectors.counting()](#operation--collectorscounting--)
      - [Operation: Collectors.mapping()](#operation--collectorsmapping--)
      - [Operation: Collectors.minBy() and Collectors.maxBy()](#operation--collectorsminby---and-collectorsmaxby--)
      - [Operation: Collectors.summing\[Int|Long|Double\]() and Collectors.averaging\[Int|Long|Double\]()](#operation--collectorssumming--int-long-double-----and-collectorsaveraging--int-long-double----)
      - [Operation: Collectors.groupingBy()](#operation--collectorsgroupingby--)
      - [Operation: Collectors.partitioningBy()](#operation--collectorspartitioningby--)
  * [Numeric Streams](#numeric-streams)
    + [Operation: range() - rangeClosed()](#operation--range-----rangeclosed--)
    + [Aggregate Operations: sum() - max() - min() - average()](#aggregate-operations--sum-----max-----min-----average--)
    + [Operations to boxing and unboxing](#operations-to-boxing-and-unboxing)
    + [Operations: mapToObj() - mapToLong and mapToDouble()](#operations--maptoobj-----maptolong-and-maptodouble--)
